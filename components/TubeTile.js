...
export default function TubeTile({
    ...
    if (compact) {
        return (
            <div className="tile video-tile tube-compact relative rounded-xl overflow-hidden backdrop-blur-xl backdrop-saturate-150 backdrop-contrast-125 backdrop-brightness-110 bg-black/20 border border-white/10 shadow-lg" style={{ ...style, height: '60px', flexDirection: 'row', alignItems: 'center', padding: '0 12px', gap: '12px' }}>
    ...
    return (
        <div className="tile video-tile relative rounded-xl overflow-hidden backdrop-blur-xl backdrop-saturate-150 backdrop-contrast-125 backdrop-brightness-110 bg-black/20 border border-white/10 shadow-lg" style={{ ...style, borderColor: (tubeState?.videoId && tubeState.isPlaying) ? '#ff0000' : 'rgba(255,0,0,0.3)' }}>
            {!tubeState?.videoId ? (
                <div style={{
                    flex: 1,
                    display: 'flex',
