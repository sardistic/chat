...
function MainApp({ user, setUser, onLeaveRoom }) {
  ...
  return (
    ...
    >
      ...
      {/* Fixed Header */}
      <header className="app-header fixed top-0 left-0 right-0 z-50 h-16 flex items-center justify-between px-4 bg-black/60 border-b border-white/10 shadow-lg">
      ...
      <div className="app-content">
        ...
        <aside
          className="floating-sidebar bg-black/40 border-l border-white/10 shadow-2xl"
          style={{
