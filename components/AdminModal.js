                        ...
                        {activeTab === 'sessions' && (
                            <div style={{ background: '#202226', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.03)', overflow: 'hidden' }}>
                                <div style={{ padding: '16px', display: 'flex', justifyContent: 'flex-end', borderBottom: '1px solid rgba(255,255,255,0.03)' }}>
                                    <button className="btn primary" onClick={() => fetchSessions(0)} style={{ padding: '6px 16px', fontSize: '13px' }}>Refresh Log</button>
                                </div>
                                ...
                                <div style={{ padding: '10px 16px', display: 'flex', justifyContent: 'flex-end', gap: '8px', borderTop: '1px solid rgba(255,255,255,0.03)' }}>
                                    <button disabled={sessionPagination.page === 0} onClick={() => fetchSessions(sessionPagination.page - 1)} className="btn secondary" style={{ padding: '4px 12px', fontSize: '12px' }}>Prev</button>
                                    <span style={{ padding: '6px', fontSize: '12px', color: '#888' }}>Page {sessionPagination.page + 1} of {sessionPagination.pages}</span>
                                    <button disabled={sessionPagination.page >= sessionPagination.pages - 1} onClick={() => fetchSessions(sessionPagination.page + 1)} className="btn secondary" style={{ padding: '4px 12px', fontSize: '12px' }}>Next</button>
                                </div>
                            </div>
                        )}
